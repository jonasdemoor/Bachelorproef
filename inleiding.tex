...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{inleiding-zfs-vs-vols}
	\caption{De combinatie van volumes en bestandsystemen (links) vergeleken met de aanpak van ZFS (rechts) \autocite{ZFSBonwick}}
	\label{fig:bonwick_volumes_vs_zfs}
\end{figure}
